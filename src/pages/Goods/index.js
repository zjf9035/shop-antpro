...
export default function Goods() {
  ...
  const columns = [
    {
      ...
      hideInSearch: true,
      render: (_, record) => {
        return <Image width={80} src={record.cover_url} />;
      },
    },
    {
      title: '标题',
  ...
  return (
    <PageContainer>
      ...
      {editshow && (
        <Edit changeEditShow={changeEditShow} editshow={editshow} actionRef={actionRef} uid={uid} />
      )}
    </PageContainer>
  );
}
